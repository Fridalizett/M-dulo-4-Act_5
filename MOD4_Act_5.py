...
data_dir = os.path.join(main_dir, 'C:/Users/HYUNDAI/Downloads/chimp/')
...
class Chimp(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image, self.rect = load_image('ghost.bmp', -1)
        screen = pygame.display.get_surface()
        self.area = screen.get_rect()
        self.rect.topleft = 10, 10
        
        self.move = 9
        self.direccion = random.randrange(5, 10)
        #self.rect.v_aleatoria_y = random.randrange(1, 10)
        self.dizzy = 0
    ...
    def _walk(self):
        ...
        newpos = self.rect.move((self.move, self.direccion))
...
#Prepare Game Objects
    ...
    whiff_sound = pygame.mixer.Sound('gunshot.wav')
    punch_sound = pygame.mixer.Sound('pacman-dies.wav')
    #
